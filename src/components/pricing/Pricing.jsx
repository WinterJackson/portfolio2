        ...
        <section className="pricing container section" id="pricing">
            ...
            <div className="pricing__container grid">
                <div className="pricing__item">
                    ...
                    <p className="pricing__title">A Simple option but powerful to manage your business Email support</p>                                
                ...
                <div className="pricing__item best">
                    ...
                    <p className="pricing__title">Unlimited product including app integration and more features Mon-Fri support</p>
